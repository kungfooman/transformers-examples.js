      ...
      createElement(
        ...
        createElement(
          ...
          createElement(
            "button",
            {
              className: 'border py-1 px-2 bg-green-400 rounded text-lg font-medium disabled:opacity-50 disabled:cursor-not-allowed',
              disabled: busy,
              onClick: run,
            },
            !busy ? 'Rerank' : status === 'loading' ? 'Model loading...' : 'Processing',
          ),
        ),
        createElement(
          "div",
