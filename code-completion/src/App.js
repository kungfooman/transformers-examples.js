...
function App() {
  ...
  function generate() {
    const val = monaco.current.getValue();
    if (!val) {
      return;
    }
  ...
  return (
    createElement(
      ...
      createElement(
        "div",
        {
          className: "gap-1 z-50 top-0 left-0 absolute w-full h-full transition-all px-32 flex flex-col justify-center text-center",
          style: {
      ...
      createElement(
        "div",
        {
          className: "flex-grow sidebar p-4 flex flex-col overflow-y-auto",
        },
        createElement(
          "h2",
          {
        ...
        createElement(
          ...
          createElement(
            "a",
            {
              className: "text-white ital underline",
        ...
        createElement(
          "select",
          {
            ...
            className: "p-2.5 bg-gray-50 border border-gray-200 text-gray-900 rounded-lg",
          },
          MODELS.map((value, i) => {
        ...
        createElement(
          ...
          createElement(
            'button',
            {
              ...
              onClick: (e) => {
                worker.current.postMessage({type: 'loadModel', model});
              }
            },
            'Initiate',
          ),
        ...
        createElement(
          ...
          createElement(
            "a",
            {
              ...
              href: "https://github.com/xenova/transformers.js/tree/main/examples/code-completion",
            },
            "Source code",
          ),
        ),
